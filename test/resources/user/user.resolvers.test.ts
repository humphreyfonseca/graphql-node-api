import { JWT_SECRET } from './../../../src/util/utils';
                ...
                it('should return a list of Users', () => {
                    ...
                    return chai.request(app)
                        ...
                        .then(res => {
                            ...
                            expect(usersList[0]).to.not.have.keys(['id', 'photo', 'createdAt', 'updateAt', 'post']);
                ...
                it('should paginate a list of Users', () => {
                    ...
                    return chai.request(app)
                        ...
                        .then(res => {
                            ...
                            expect(usersList[0]).to.not.have.keys(['id', 'photo', 'updateAt', 'post']);
                ...
                it('should create new User',() => {
                    ...
                    return chai.request(app)
                        ...
                        .then(res => {
                            ...
                            expect(parseInt(createdUser.email)).to.be.a('number');
                        }).catch(handleError);
